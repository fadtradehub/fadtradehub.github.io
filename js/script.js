window.addEventListener('DOMContentLoaded', () => {
  ...
  const dataProduct = [
    {
      image: 'produk1.png',
      name: 'Jasa urus dokumen export',
      price: 'Negosiasi',
      description: 'Layanan pengurusan dokumen eksport yang cepat, akurat dan sesuai regulasi internasional guna memastikan kelancaran pengiriman barang Anda tanpa kendala administratif'
    },
    {
      image: 'produk2.png',
      name: 'Jasa urus dokumen import',
      price: 'Negosiasi',
      description: 'Layanan pengurusan dokumen import yang cepat, akurat dan sesuai regulasi internasional guna memastikan kelancaran penerimaan barang Anda tanpa kendala administratif'
    },
    {
      image: 'produk3.png',
      name: 'Brokerage',
      price: 'Negosiasi',
      description: 'Layanan perantara perdagangan internasional yang menangani seluruh proses pengiriman barang antarnegara dengan kepatuhan regulasi penuh dan prosedur yang transparan'
    },
    {
      image: 'produk4.png',
      name: 'Manajemen logistik dan gudang',
      price: 'Negosiasi',
      description: 'Solusi pengelolaan alur barang dan optimasi inventori menggunakan metode efisien ( seperti FIFO/FEFO ) serta desain tata letak gudang untuk memastikan operasional yang lancar'
    },
    {
      image: 'produk5.png',
      name: 'Analisis rantai pasok',
      price: 'Negosiasi',
      description: 'Konsultasi strategis untuk meningkatkan efisiensi jalur distribusi global Anda'
    },
    {
      image: 'produk6.png',
      name: 'Desain tata letak gudang',
      price: 'Negosiasi',
      description : 'Layanan optimasi alur dan pengaturan ruang untuk memaksimalkan kapasitas penyimpanan serta meningkatkan efisiensi proses distribusi barang secara menyeluruh'
    }
  ];
  /* ========== DATA PRODUCT END ========== */
...
form.addEventListener('submit', async (e) => {
    ...
    formData.append("access_key", "60628023-d232-4e9f-b2e0-a3d9cb7ac5c3");
